...
class PriorityQueue:
    ...
    def replace(self, child):
        ...
        if (
            self.contains(child)
            and self.fn[child.state] > int(problem.h(child.state)) + child.path_cost
        ):
...
class Problem(object):
    def __init__(self, init_state, goal_state):
        ...
        self.state_space = {}
        self.state_space["Arad"] = {
            "GoZerind": "Zerind",
            "GoSibiu": "Sibiu",
            "GoTimisoara": "Timisoara",
        }
        ...
        self.state_space["Lugoj"] = {
            "GoTimisoara": "Timisoara",
            "GoMehandia": "Mehandia",
        }
        self.state_space["Drobeta"] = {"GoMehandia": "Mehandia", "GoCraiova": "Craiova"}
        self.state_space["Craiova"] = {
            "GoDrobeta": "Drobeta",
            "GoRimnicu": "Rimnicu Vilcea",
            "GoPitesti": "Pitesti",
        }
        self.state_space["Rimnicu Vilcea"] = {
            "GoSibiu": "Sibiu",
            "GoPitesti": "Pitesti",
            "GoCraoova": "Craiova",
        }
        self.state_space["Sibiu"] = {
            "GoArad": "Arad",
            "GoFagaras": "Fagaras",
            "GoOradea": "Oradea",
            "GoRimnicu": "Rimnicu Vilcea",
        ...
        self.state_space["Pitesti"] = {
            "GoRimnicu": "Rimnicu Vilcea",
            "GoCraiova": "Craiova",
            "GoBucharest": "Bucharest",
        }
        self.state_space["Bucharest"] = {
            "GoFagaras": "Fagaras",
            "GoPitesti": "Pitesti",
            "GoGiurgiu": "Giurgiu",
            "GoUrziceni": "Urziceni",
        ...
        self.step_cost["Craiova"] = {
            "GoDrobeta": "120",
            "GoRimnicu": "146",
            "GoPitesti": "138",
        }
        self.step_cost["Rimnicu Vilcea"] = {
            "GoSibiu": "80",
            "GoPitesti": "97",
            "GoCraoova": "146",
        }
        self.step_cost["Sibiu"] = {
            "GoArad": "140",
            "GoFagaras": "99",
            "GoOradea": "151",
            "GoRimnicu": "80",
        ...
        self.step_cost["Pitesti"] = {
            "GoRimnicu": "97",
            "GoCraiova": "138",
            "GoBucharest": "101",
        }
        self.step_cost["Bucharest"] = {
            "GoFagaras": "211",
            "GoPitesti": "101",
            "GoGiurgiu": "90",
            "GoUrziceni": "85",
