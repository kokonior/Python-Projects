...
ds = {
    44: ["HAM", 0, "United Kingdom", "MERCEDES", "LEWIS HAMILTON"],
    77: ["BOT", 0, "Finland", "MERCEDES", "VALTTERI BOTTAS"],
    33: ["VER", 0, "Netherlands", "RED BULL RACING-HONDA", "MAX VERSTAPPEN"],
    11: ["PER", 0, "Mexico", "RED BULL RACING-HONDA", "SERGIO PEREZ"],
    16: ["LEC", 0, "Monaco", "SCUDERIA FERRARI", "CHARLES LECLERC"],
    55: ["SAI", 0, "Spain", "SCUDERIA FERRARI", "CARLOS SAINZ"],
    4: ["NOR", 0, "United Kingdom", "McLAREN-MERCEDES", "LANDO NORRIS"],
    3: ["RIC", 0, "Australia", "McLAREN-MERCEDES", "DANIEL RICCIARDO"],
    10: ["GAS", 0, "France", "ALPHA TAURI-HONDA", "PIERRE GASLY"],
    22: ["TSU", 0, "Japan", "ALPHA TAURI-HONDA", "YUKI TSUNODA"],
    5: ["VET", 0, "Germany", "ASTON MARTIN-MERCEDES", "SEBASTIAN VETTEL"],
    18: ["STR", 0, "Canada", "ASTON MARTIN-MERCEDES", "LANCE STROLL"],
    14: ["ALO", 0, "Spain", "ALPINE-RENAULT", "FERNANDO ALONSO"],
    31: ["OCO", 0, "France", "ALPINE-RENAULT", "ESTEBAN OCON"],
    7: ["RAI", 0, "Finland", "ALFA ROMEO", "KIMI RAIKKONEN"],
    99: ["GIO", 0, "Italy", "ALFA ROMEO", "ANTONIO GIOVANNAZI"],
    47: ["SCH", 0, "Germany", "HAAS-FERRARI", "MICK SCHUMACHER"],
    9: ["MAZ", 0, "Russia", "HAAS-FERRARI", "NIKITA MAZEPIN"],
    63: ["RUS", 0, "United Kingdom", "WILLIAMS RACING", "GEORGE RUSSEL"],
    6: ["LAT", 0, "Canada", "WILLIAMS RACING", "NICHOLAS LATIFI"],
}
...
graph = [
    [0, 8, 999, 999, 999, 18, 10, 999, 999, 999],
