...
def main():
    ...
    print(
        "We can use the // shortcut to get the same thing more easily: '{}'".format(
    ...
    print(
        "We can get the id attributes of all the <li> elements. There are {} of them, the first one is {}".format(
            len(ids), ids[0]
        )
    )
    ...
    print(
        "We can get the parent element of the tagcloud using an attribute selector: {}".format(
            tagcloud
        )
    )
    ...
    print(
        "Another way to get the title is to select by element text content: '{}'".format(
            title[0].text.strip()
        )
    )
    ...
    print(
        "We can use the .. operator is select the subtitle: '{}'".format(
    ...
    print(
        "Or we can use following-sibling to same effect: '{}'".format(
            subtitle[0].text.strip()
        )
    )
